                        ...
                        <Form label-position="top">
                                ...
                                >
                                    ...
                                    >
                                        <Icon
                                            type="md-trash"
                                            size="15"
                                            @click.native="removeRow(rowkey)"
                                        ></Icon>
                                    </div>
                                    <Col
                                        v-for="(column, colkey) in row"
                                        :key="colkey"
                                        :span="24 / row.length"
                                    >
                                        <p
                            ...
                            <div class="form-row-btn">
                                <Poptip placement="bottom">
                                    ...
                                    <Button type="text" icon="md-add-circle">
                                        添加行
                                    </Button>
                                </Poptip>
                            </div>
                    ...
                    <div slot="right" class="form-split-pane right">
                        ...
                        >
                            ...
                            <FormItem>
                                ...
                                <Row
                                    :gutter="5"
                                    v-for="(item, index) in currentInput.styles"
                                    :key="index"
                                >
                                    <Col span="8">
                                        <Input
                            ...
                            <FormItem
                                :label="L('选项') + '：'"
                                v-if="currentInput.items"
                            >
                                <Row
                                    :gutter="5"
                                    v-for="(item, index) in currentInput.items"
                                    :key="index"
                                >
                                    <Col span="8">
                                        <Input

...
{
    [DbContext(typeof(WorkflowDemoDbContext))]
    partial class WorkflowDemoDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkflowDemo.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("WorkflowDemo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("WorkflowDemo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WorkflowDemo.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("WorkflowDemo.Authorization.Users.User", "DeleterUser")
                        .WithMany()

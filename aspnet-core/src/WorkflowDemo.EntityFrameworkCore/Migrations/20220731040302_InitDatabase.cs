    ...
    public partial class InitDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(maxLength: 64, nullable: false),
                    WorkflowId = table.Column<string>(maxLength: 64, nullable: true),
                    ExecutionPointerId = table.Column<string>(maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalToken = table.Column<string>(maxLength: 100, nullable: true),
                    ExternalWorkerId = table.Column<string>(maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredecessorId = table.Column<string>(maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(maxLength: 64, nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExecutionPointerId = table.Column<string>(nullable: true),

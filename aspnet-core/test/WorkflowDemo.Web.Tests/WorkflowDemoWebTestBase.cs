...
{
    public abstract class WorkflowDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WorkflowDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WorkflowDemoWebCoreModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WorkflowDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WorkflowDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WorkflowDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WorkflowDemoDbContext, Task<T>> func)
        {
            T result;
